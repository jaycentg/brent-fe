    ...
    return (
        <main className="flex min-h-screen flex-col">
            ...
            <Box paddingY={5} paddingX={10}>
                ...
                <DocumentCard title={"15"} content={"dasdadsa"} />
                <DocumentCard title={"20"} content={"dasdadsa"} />
                <DocumentCard title={"30"} content={"dasdadsa"} />
                <DocumentCard title={"40"} content={"dasdadsa"} />
                <DocumentCard title={"50"} content={"dasdadsa"} />
                <DocumentCard title={"60"} content={"dasdadsa"} />
                <DocumentCard title={"70"} content={"dasdadsa"} />
            </Box>
            <Box height='4rem'></Box>
            <Footer />       
        </main>
